...
pub const VSCODE: &str = "C:\\Users\\coffe\\AppData\\Local\\Programs\\Microsoft VS Code\\Code.exe";
...
pub const _CONFIGURE_TASKBAR: &str = include_str!("scripts/configure_taskbar.ps1");
